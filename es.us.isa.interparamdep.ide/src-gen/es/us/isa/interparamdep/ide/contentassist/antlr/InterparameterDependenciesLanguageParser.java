...
public class InterparameterDependenciesLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, InterparameterDependenciesLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getParamValueRelationAccess().getAlternatives(), "rule__ParamValueRelation__Alternatives");
			...
			builder.put(grammarAccess.getParamValueRelationAccess().getGroup_0(), "rule__ParamValueRelation__Group_0__0");
			builder.put(grammarAccess.getParamValueRelationAccess().getGroup_0_3(), "rule__ParamValueRelation__Group_0_3__0");
			builder.put(grammarAccess.getParamValueRelationAccess().getGroup_1(), "rule__ParamValueRelation__Group_1__0");
			builder.put(grammarAccess.getParamValueRelationAccess().getGroup_2(), "rule__ParamValueRelation__Group_2__0");
			builder.put(grammarAccess.getParamValueRelationAccess().getGroup_3(), "rule__ParamValueRelation__Group_3__0");
			...
			builder.put(grammarAccess.getParamValueRelationAccess().getStringValuesAssignment_0_2(), "rule__ParamValueRelation__StringValuesAssignment_0_2");
			builder.put(grammarAccess.getParamValueRelationAccess().getStringValuesAssignment_0_3_1(), "rule__ParamValueRelation__StringValuesAssignment_0_3_1");
			builder.put(grammarAccess.getParamValueRelationAccess().getPatternStringAssignment_1_2(), "rule__ParamValueRelation__PatternStringAssignment_1_2");
			builder.put(grammarAccess.getParamValueRelationAccess().getBooleanValueAssignment_2_2(), "rule__ParamValueRelation__BooleanValueAssignment_2_2");
			builder.put(grammarAccess.getParamValueRelationAccess().getRelationalOpAssignment_3_1(), "rule__ParamValueRelation__RelationalOpAssignment_3_1");
			builder.put(grammarAccess.getParamValueRelationAccess().getDoubleValueAssignment_3_2(), "rule__ParamValueRelation__DoubleValueAssignment_3_2");
