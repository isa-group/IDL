...
public class InterparameterDependenciesLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, InterparameterDependenciesLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getClauseAccess().getFirstElementAlternatives_2_0_0(), "rule__Clause__FirstElementAlternatives_2_0_0");
			...
			builder.put(grammarAccess.getOperationAccess().getFirstParamAssignment_1_1(), "rule__Operation__FirstParamAssignment_1_1");
			builder.put(grammarAccess.getOperationAccess().getOperationContinuationAssignment_1_2(), "rule__Operation__OperationContinuationAssignment_1_2");
			builder.put(grammarAccess.getOperationAccess().getOperationContinuation2Assignment_1_4(), "rule__Operation__OperationContinuation2Assignment_1_4");
