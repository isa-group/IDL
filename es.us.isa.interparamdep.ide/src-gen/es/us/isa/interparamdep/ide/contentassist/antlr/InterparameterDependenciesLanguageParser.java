...
public class InterparameterDependenciesLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, InterparameterDependenciesLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPositiveClauseAccess().getPositiveFirstElementAlternatives_1_1_0(), "rule__PositiveClause__PositiveFirstElementAlternatives_1_1_0");
			...
			builder.put(grammarAccess.getAtomicAccess().getParamAssignmentAssignment_1_1(), "rule__Atomic__ParamAssignmentAssignment_1_1");
			...
			builder.put(grammarAccess.getPositiveClauseAccess().getPositiveFirstElementAssignment_0_0(), "rule__PositiveClause__PositiveFirstElementAssignment_0_0");
			builder.put(grammarAccess.getPositiveClauseAccess().getPositiveClauseContinuationAssignment_0_1(), "rule__PositiveClause__PositiveClauseContinuationAssignment_0_1");
			builder.put(grammarAccess.getPositiveClauseAccess().getPositiveFirstElementAssignment_1_1(), "rule__PositiveClause__PositiveFirstElementAssignment_1_1");
			builder.put(grammarAccess.getPositiveClauseAccess().getPositiveClauseContinuationAssignment_1_2(), "rule__PositiveClause__PositiveClauseContinuationAssignment_1_2");
			builder.put(grammarAccess.getPositiveClauseAccess().getPositiveClauseContinuation2Assignment_1_4(), "rule__PositiveClause__PositiveClauseContinuation2Assignment_1_4");
			builder.put(grammarAccess.getPositiveClauseAccess().getPositiveClauseContinuationAssignment_2_1(), "rule__PositiveClause__PositiveClauseContinuationAssignment_2_1");
